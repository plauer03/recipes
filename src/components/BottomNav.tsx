...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 w-full max-w-[450px] h-[calc(65px+env(safe-area-inset-bottom))] glass border-t border-[var(--border)] flex justify-around items-center px-2 z-50 pb-[env(safe-area-inset-bottom)]">
      {navItems.map((item) => {
