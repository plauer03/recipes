  ...
  async function handleSave() {
    ...
    try {
      ...
      if (editingId) {
        ...
        // DELETE old relations first (True reset)
  ...
  return (
    <div className="space-y-6 fade-in h-full flex flex-col overflow-hidden">
      ...
      <div className="relative shrink-0">
        ...
        <input type="text" placeholder="Suchen..." className="w-full bg-[var(--card)] border border-[var(--border)]/10 rounded-2xl py-3.5 pl-11 pr-4 font-medium outline-none shadow-sm" />
      </div>
          ...
          recipes.map(r => (
            <div key={r.id} onClick={() => openRecipeDetails(r)} className="bg-[var(--card)] p-4 rounded-2xl border border-[var(--border)]/5 shadow-sm flex items-center gap-4 ios-active-scale cursor-pointer">
              ...
              <div className="flex-1 truncate">
                ...
                <p className="text-[10px] text-[var(--muted-foreground)] font-bold uppercase tracking-tight opacity-60">Basis: {r.base_portions || 2} Pers.</p>
              </div>
